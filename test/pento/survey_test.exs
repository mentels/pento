defmodule Pento.SurveyTest do
  ...
  describe "demographics" do
    ...
    test "create_demographic/1 with valid data creates a demographic" do
      valid_attrs = %{gender: "male", year_of_birth: 2018, user_id: user_fixture().id}

      assert {:ok, %Demographic{} = demographic} = Survey.create_demographic(valid_attrs)
      assert demographic.gender == "male"
      assert demographic.year_of_birth == 2018
      assert demographic.user_id == valid_attrs.user_id
    end
    ...
    test "change_demographic/1 returns demographic changeset" do
      demographic = demographic_fixture()
  ...
  describe "ratings" do
    ...
    test "create_rating/1 with valid data creates a rating" do
      ...
      assert rating.user_id == valid_attrs.user_id
      assert rating.product_id == valid_attrs.product_id
    end
